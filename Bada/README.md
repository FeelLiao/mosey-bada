...
It targets interop with stock Android Quick Share, NearDrop on macOS, Quick
Share on Windows, and Apple AirDrop on supported Mosey/KernelSU devices.
...
- On a device with the Mosey Enabler module, discovers Apple AirDrop peers and
  sends/receives files through AirDrop HTTPS, binary plist, and CPIO/DVZIP.
