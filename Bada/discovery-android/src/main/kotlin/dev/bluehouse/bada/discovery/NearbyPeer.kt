...
public data class NearbyPeer(
    ...
    val airDropEndpoint: AirDropEndpoint? = null,
) {
    /**
    ...
    public val candidateMediums: Set<Medium>
        get() =
            buildSet {
                ...
                if (airDropEndpoint != null) add(Medium.MOSEY)
            }
    ...
    public fun preferredRoute(): NearbyPeerRoute? {
        val airDrop = airDropEndpoint
        if (airDrop != null) {
            return NearbyPeerRoute.AirDrop(
                host = airDrop.host,
                port = airDrop.port,
                serviceName = airDrop.serviceName,
            )
        }
    ...
    public fun displayName(): String {
        ...
        val airDropName = airDropEndpoint?.displayName.toDisplayNameOrNull()
        if (airDropName != null) return airDropName
    ...
    public fun displayNameSource(): String {
        ...
        return when {
            ...
            airDropEndpoint?.displayName.toDisplayNameOrNull() != null -> "airdrop-discover"
    ...
    /** Resolved Apple AirDrop HTTPS endpoint on the AWDL interface. */
    public data class AirDropEndpoint(
