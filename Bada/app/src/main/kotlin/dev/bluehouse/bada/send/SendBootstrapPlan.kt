...
internal data class SendBootstrapPlan(
            ...
            override val diagnosticLabel: String
                get() =
                    when (route) {
                        ...
                        is NearbyPeerRoute.AirDrop -> "airdrop"
    ...
    companion object {
        ...
        private fun direct(
            ...
            val subtitle =
                when (route) {
                    ...
                    is NearbyPeerRoute.AirDrop -> "AirDrop ${route.host}:${route.port}"
        ...
        private fun airDropRoute(peer: NearbyPeer): NearbyPeerRoute.AirDrop? =
            peer.airDropEndpoint?.let { endpoint ->
