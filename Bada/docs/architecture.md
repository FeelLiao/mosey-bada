...
> Apple-side interop is implemented as an optional Android layer backed by the
> KernelSU Mosey bridge. It does not alter the pure Quick Share protocol core.
...
:service-android      ForegroundService, notifications, MediaStore writes,
                      AirDrop HTTPS/plist/CPIO sender and loopback receiver
:discovery-android    NsdManager wrappers, BLE advertise/scan, Bluetooth Classic bootstrap,
                      Mosey bridge event subscription
